    ...
    public static void main(String[] args) {
        printDynamicMatrixElements();
            ...
            public static void printArraySum () {
                double[] Array_numbers = {0, 0.5, 1, 1.5, 2, 2.5};
                double sum_of_all_numbers = 0;

                for (double num : Array_numbers) {
                    sum_of_all_numbers += num;
                }

                System.out.println("The sum of the array is: " + sum_of_all_numbers);
            }
