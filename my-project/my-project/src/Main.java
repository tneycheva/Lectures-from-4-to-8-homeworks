...
class Main {
    ...
    public static void printName() {
        String first_name = " Teodora";
        String middle_name = " Todorova";
        String last_name = " Neycheva";
    ...
    public static void triangleArea() {
        int side_A = 1;
        int side_B = 10;
        int triangle_area = (side_A * side_B) / 2;
...
System.out.println("Enter a side a size");
int a = myObj.nextInt();

System.out.println("Enter a side b size");
int b = myObj.nextInt();
